            ...
            <div className="border-t border-dashed pt-2" style={{ borderColor: "#1FA0FF33" }}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2 sm:col-span-2">
                  ...
                  <Input className="h-12 rounded-xl" style={{ borderColor: "#1FA0FF33" }} placeholder="أدخل الاسم الرباعي" value={form.studentName} onChange={(e) => set("studentName", e.target.value)} />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input className="h-12 rounded-xl" style={{ borderColor: "#1FA0FF33" }} placeholder="أدخل الرقم الوطني" value={form.nationalId} onChange={(e) => set("nationalId", e.target.value)} />
                </div>
                <div className="space-y-2">
                  <Label className="font-semibold text-[#1A1A1A]">تاريخ الميلاد *</Label>
                  <Input type="date" className="h-12 rounded-xl" style={{ borderColor: "#1FA0FF33" }} value={form.birthDate} onChange={(e) => set("birthDate", e.target.value)} />
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-dashed pt-2" style={{ borderColor: "#12DAFB33" }}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input className="h-12 rounded-xl" style={{ borderColor: "#12DAFB33" }} placeholder="اسم ولي الأمر" value={form.guardianName} onChange={(e) => set("guardianName", e.target.value)} />
                </div>
                <div className="space-y-2">
                  <Label className="font-semibold text-[#1A1A1A]">رقم هاتف ولي الأمر *</Label>
                  <Input className="h-12 rounded-xl" style={{ borderColor: "#12DAFB33" }} placeholder="09XXXXXXXX" value={form.guardianPhone} onChange={(e) => set("guardianPhone", e.target.value)} />
                </div>
                <div className="space-y-2">
                  <Label className="font-semibold text-[#1A1A1A]">اسم الأم *</Label>
                  <Input className="h-12 rounded-xl" style={{ borderColor: "#12DAFB33" }} placeholder="اسم الأم" value={form.motherName} onChange={(e) => set("motherName", e.target.value)} />
                </div>
                <div className="space-y-2">
                  <Label className="font-semibold text-[#1A1A1A]">رقم هاتف الأم *</Label>
                  <Input className="h-12 rounded-xl" style={{ borderColor: "#12DAFB33" }} placeholder="09XXXXXXXX" value={form.motherPhone} onChange={(e) => set("motherPhone", e.target.value)} />
                </div>
              </div>
            </div>
